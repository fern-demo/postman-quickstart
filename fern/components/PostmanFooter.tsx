export default function PostmanFooter() {
  const linkStyle =
    "block text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors py-1";
  const headingStyle =
    "text-sm font-semibold text-gray-900 dark:text-white mb-3";

  return (
    <footer className="w-full border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#111113]">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div>
            <h3 className={headingStyle}>Product</h3>
            <ul className="space-y-1">
              <li>
                <a href="https://www.postman.com/product/" className={linkStyle}>
                  Postman Overview
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://www.postman.com/pricing/" className={linkStyle}>
                  Plans and Pricing
                </a>
              </li>
            </ul>
          ...
          <div>
            <h3 className={headingStyle}>API Network</h3>
            <ul className="space-y-1">
              <li>
                <a
                  href="https://www.postman.com/category/app-security/"
                  className={linkStyle}
                >
                  App Security
                </a>
              ...
              <li>
                <a
                  href="https://www.postman.com/category/payments/"
                  className={linkStyle}
                >
                  Payments
                </a>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href="https://academy.postman.com/" className={linkStyle}>
                  Academy
                </a>
              </li>
              <li>
                <a href="https://community.postman.com/" className={linkStyle}>
                  Community
                </a>
              </li>
              <li>
                <a
                  href="https://www.postman.com/templates/"
                  className={linkStyle}
                >
                  Templates
                </a>
              ...
              <li>
                <a
                  href="https://www.youtube.com/postman/"
                  className={linkStyle}
                >
                  Videos
                </a>
          ...
          <div>
            <h3 className={headingStyle}>Legal and Security</h3>
            <ul className="space-y-1">
              <li>
                <a href="https://www.postman.com/legal/" className={linkStyle}>
                  Legal Terms Hub
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="https://privacy.postman.com/policies/"
                  className={linkStyle}
                >
                  Privacy Policy
                </a>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="Follow Postman on X"
            ...
            <a
              ...
              aria-label="Follow Postman on LinkedIn"
              className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
              <svg
                className="w-5 h-5"
            ...
            <a
              ...
              aria-label="Contribute to Postman on GitHub"
              className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
              <svg
                className="w-5 h-5"
            ...
            <a
              href="https://www.youtube.com/postman"
              aria-label="Watch Postman on YouTube"
              className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
              <svg
                className="w-5 h-5"
            ...
            <a
              ...
              aria-label="Follow Postman on Instagram"
              className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
              <svg
                className="w-5 h-5"
            ...
            <a
              href="https://discord.gg/rKZgwpZqqV"
              aria-label="Follow Postman on Discord"
              className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
              <svg
                className="w-5 h-5"
